...
Подробные инструкции участников: [Темирлан — frontend](docs/participant1-frontend.md), [Мирас — backend](docs/participant2-backend.md), [Айназ — данные и демо](docs/participant3-data-audit.md).
