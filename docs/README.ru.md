...
Визуальный референс интерфейса Rio: [rio-ui-reference.png](screenshots/rio-ui-reference.png). Фактические снимки сценариев 01–06 сохраняются в этой же папке после запуска локального сайта `python app.py`; в подписи к каждому снимку указываются входные параметры и ожидаемый исход.
