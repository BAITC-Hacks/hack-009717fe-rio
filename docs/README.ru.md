...
| `data/contractors.csv` | Исходные 66 профилей без изменений |
...
В runtime-каталоге 78 профилей: исходные 66 и 12 синтетических профилей команды. Исходный CSV не изменён; дополнительные записи находятся в `data/synthetic_profiles.csv` и помечены `synthetic=True`.

## Данные, источники и внешние сервисы

78 профилей в runtime-каталоге: 66 анонимизированных профилей организаторов и 12 синтетических профилей команды. Исходный CSV и HTML-превью сохранены как исходный слой; дополнительные записи находятся в `data/synthetic_profiles.csv`.
